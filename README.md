About unittest-xml-reporting-feedstock
======================================
...
Once the `conda-forge` channel has been enabled, `unittest-xml-reporting` can be installed with `conda`:
...
```
mamba install unittest-xml-reporting
```

It is possible to list all of the versions of `unittest-xml-reporting` available on your platform with `conda`:
...
```
mamba search unittest-xml-reporting --channel conda-forge
```
...
mamba repoquery search unittest-xml-reporting --channel conda-forge

# List packages depending on `unittest-xml-reporting`:
mamba repoquery whoneeds unittest-xml-reporting --channel conda-forge

# List dependencies of `unittest-xml-reporting`:
mamba repoquery depends unittest-xml-reporting --channel conda-forge
```
